...
class DT_Genmapper_Groups_Chart extends DT_Genmapper_Metrics_Chart_Base
{
    ...
    public function scripts()
    {
        ...
        wp_localize_script(
            'gen-template', 'genApiTemplate', [
                ...
                'icons' => DT_Genmapper_Plugin_Icons::instance()->forJs()
            ]
        );
    ...
    public function groups(WP_REST_Request $request)
    {
        ...
        foreach ($groups as $group) {
            ...
            if ($group['start_date']) {
                $lines[] = date(get_option('date_format'), $group['start_date']);
            }
            ...
            $values = [
                ...
                "start_date" => $group['start_date'] ? date(get_option('date_format'), $group['start_date']) : null,
